...
#define OV2640_SENSOR_ADDR          0x30                       /*!< Slave address of the MPU9250 sensor */
...
/****************************************************************/
  ...
  bool CAM_start(void);
  bool CAM_standby(void);
  bool CAM_resume(void);
	...
	void CAM_set_mode(uint8_t mode);
 
  uint8_t CAM_bus_write(int address, int value);
	uint8_t CAM_bus_read(int address);	
 
	// Write 8 bit values to 8 bit register address
	int CAM_wrSensorRegs8_8(const struct sensor_reg*);
	
	// Write 16 bit values to 8 bit register address
	int CAM_wrSensorRegs8_16(const struct sensor_reg*);
	
	// Write 8 bit values to 16 bit register address
	int CAM_wrSensorRegs16_8(const struct sensor_reg*);
	
  // Write 16 bit values to 16 bit register address
	int CAM_wrSensorRegs16_16(const struct sensor_reg*);
	...
	byte CAM_wrSensorReg8_16(int regID, int regDat);
	byte CAM_rdSensorReg8_16(uint8_t regID, uint16_t* regDat);
	...
	byte CAM_wrSensorReg16_16(int regID, int regDat);
	byte CAM_rdSensorReg16_16(uint16_t regID, uint16_t* regDat);

	void CAM_OV2640_set_JPEG_size(uint8_t size);
	void CAM_OV3640_set_JPEG_size(uint8_t size);
	void CAM_OV5642_set_JPEG_size(uint8_t size);
	void CAM_OV5640_set_JPEG_size(uint8_t size);
	
	void CAM_OV5642_set_RAW_size (uint8_t size);
	
	
	void CAM_OV2640_set_Light_Mode(uint8_t Light_Mode);
  void CAM_OV3640_set_Light_Mode(uint8_t Light_Mode);
	void CAM_OV5642_set_Light_Mode(uint8_t Light_Mode);
	void CAM_OV5640_set_Light_Mode(uint8_t Light_Mode);
	
	void CAM_OV2640_set_Color_Saturation(uint8_t Color_Saturation);
	void CAM_OV3640_set_Color_Saturation(uint8_t Color_Saturation);
	void CAM_OV5642_set_Color_Saturation(uint8_t Color_Saturation);
	void CAM_OV5640_set_Color_Saturation(uint8_t Color_Saturation);
	
	
	void CAM_OV2640_set_Brightness(uint8_t Brightness);
	void CAM_OV3640_set_Brightness(uint8_t Brightness);
  void CAM_OV5642_set_Brightness(uint8_t Brightness);
  void CAM_OV5640_set_Brightness(uint8_t Brightness);
	
	void CAM_OV2640_set_Contrast(uint8_t Contrast);
	void CAM_OV3640_set_Contrast(uint8_t Contrast);
	void CAM_OV5642_set_Contrast(uint8_t Contrast);
	void CAM_OV5640_set_Contrast(uint8_t Contrast);
	
	void CAM_OV2640_set_Special_effects(uint8_t Special_effect);
	void CAM_OV3640_set_Special_effects(uint8_t Special_effect);
	void CAM_OV5642_set_Special_effects(uint8_t Special_effect);
	void CAM_OV5640_set_Special_effects(uint8_t Special_effect);
	
	
	void CAM_OV3640_set_Exposure_level(uint8_t level);
	void CAM_OV3640_set_Sharpness(uint8_t Sharpness);
	void CAM_OV3640_set_Mirror_Flip(uint8_t Mirror_Flip);
  ...
  void CAM_OV5640_set_EV(uint8_t EV);
  void CAM_OV5640_set_Night_Mode(uint8_t Night_mode);
  void CAM_OV5640_set_Banding_Filter(uint8_t Banding_Filter);
	
	
	
	
	void CAM_set_format(byte fmt);
	void CAM_transferBytes_(uint8_t * out, uint8_t * in, uint8_t size);
	void CAM_transferBytes(uint8_t * out, uint8_t * in, uint32_t size);
	
  //inline void CAM_setDataBits(uint16_t bits);
